...
sources/L1/Crypto\ Libraries/aes256.o: ../sources/L1/Crypto\ Libraries/aes256.cpp
	...
	g++ -O0 -g3 -Wall -c -fmessage-length=0 -DSQLITE_TEMP_STORE=3 -std=c++17 -pthread -MMD -MP -MF"sources/L1/Crypto Libraries/aes256.d" -MT"sources/L1/Crypto\ Libraries/aes256.d" -o "$@" "$<"
...
sources/L1/Crypto\ Libraries/pbkdf2.o: ../sources/L1/Crypto\ Libraries/pbkdf2.c
	@echo 'Building file: $<'
	@echo 'Invoking: GCC C Compiler'
	gcc -O0 -g3 -Wall -c -fmessage-length=0 -DSQLITE_TEMP_STORE=3 -pthread -MMD -MP -MF"sources/L1/Crypto Libraries/pbkdf2.d" -MT"sources/L1/Crypto\ Libraries/pbkdf2.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
...
sources/L1/Crypto\ Libraries/sha256.o: ../sources/L1/Crypto\ Libraries/sha256.c
	@echo 'Building file: $<'
	@echo 'Invoking: GCC C Compiler'
	gcc -O0 -g3 -Wall -c -fmessage-length=0 -DSQLITE_TEMP_STORE=3 -pthread -MMD -MP -MF"sources/L1/Crypto Libraries/sha256.d" -MT"sources/L1/Crypto\ Libraries/sha256.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
